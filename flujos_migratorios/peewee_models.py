...
class Demography(BaseModel):
    ...
    net_migration = FloatField(null=True)
    ...
    population_total = FloatField(null=True)
    ...
    urban_population = FloatField(null=True)
...
class Health(BaseModel):
    ...
    life_expectancy_at_birth_total_years = FloatField(null=True)
